...
// Alloue dynamiquement la mémoire pour la map du jeu
//  et une copie utilisée pour les vérifications.
// Chaque ligne est une chaîne de caractères de 
// taille size_x + 1 (pour le '\0').
...
// Vérifie que chaque caractère de la map est valide 
// ('1', '0', 'P', 'C', 'E' ou 'T').
// Quitte le programme avec une erreur si un
//  caractère inconnu est trouvé.
...
// Vérifie que le buffer de la map n’est 
// pas vide après lecture du fichier.
// Si vide, libère les ressources, 
// ferme le fichier et affiche une erreur.
